...
export default function Footer() {
  ...
  const socialLinks = [
    { name: 'Twitter', icon: Twitter, href: 'https://twitter.com/invoicely' },
    { name: 'Facebook', icon: Facebook, href: 'https://facebook.com/invoicely' },
    { name: 'Instagram', icon: Instagram, href: 'https://instagram.com/invoicely' },
    { name: 'LinkedIn', icon: Linkedin, href: 'https://linkedin.com/company/invoicely' },
    { name: 'GitHub', icon: Github, href: 'https://github.com/invoicely' },
  ];
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                50,000 businesses worldwide. Get paid faster with automated reminders and integrated
                payment processing.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">support@invoicely.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">1-800-INVOICE (468-6423)</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <MapPin className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">Financial District, San Francisco, CA</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get invoicing tips, tax updates, and feature announcements. Unsubscribe anytime.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 Invoicely. All rights reserved.</span>
              <span className="hidden sm:inline">•</span>
              <span className="hidden sm:inline flex items-center gap-1">
                Made with <Heart className="size-3 text-accent fill-current" /> for business owners
              </span>
            </div>
